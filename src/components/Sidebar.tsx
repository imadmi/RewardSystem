  ...
  return (
    ...
    >
      <ul className="space-y-4 text-gray-300 hover:cursor-pointer">
        <li
          className={`${
            activeComponent === "PointsSummary" ? "text-white font-bold" : ""
          }`}
        ...
        <li
          className={`${
            activeComponent === "Customers" ? "text-white font-bold" : ""
          }`}
          onClick={() => dispatch(setActiveComponent("Customers"))}
        >
          Customers
        </li>
        <li
          className={`${
            activeComponent === "Promotions" ? "text-white font-bold" : ""
          }`}
          onClick={() => dispatch(setActiveComponent("Promotions"))}
        >
          Promotions
        </li>
      </ul>
